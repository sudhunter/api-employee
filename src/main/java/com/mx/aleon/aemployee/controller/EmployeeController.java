...
public class EmployeeController {
    ...
    @Operation(
        ...
        description = "Fetches the details of a specific employee based on their unique identifier",
        responses = {
    ...
    public ResponseEntity<GenericResponse> getById(@PathVariable Long id) {
        ...
        try {
            ...
            return faildResponse(e.getCode(), e.getMessage(), response, HttpStatus.NOT_FOUND);
        } finally {
    ...
    public ResponseEntity<GenericResponse> createEmployee(@RequestBody EmployeeVO employee) {
        ...
        try {
            ...
            return faildResponse(e.getCode(), e.getMessage(), response, HttpStatus.BAD_REQUEST);
        } finally {
    ...
    @Operation(
        ...
        description = "Adds multiple employees to the system",
		requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
    ...
    private ResponseEntity<GenericResponse> faildResponse(int code, String message, GenericResponse response, HttpStatus httpStatus){
